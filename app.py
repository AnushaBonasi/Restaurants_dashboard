...
st.set_page_config(page_title="Restaurants Interactive Dashboard", page_icon="\U0001f37d\ufe0f",
...
st.markdown(f"""<div class='header-bar'>
    <div style='display:flex;align-items:center;gap:14px;'>
        ...
        <div>
            <div style='font-weight:800;font-size:1.1rem;color:{header_title_color};'> Restaurants Interactive Dashboard</div>
...
st.markdown(f"<div style='text-align:center;color:{footer_color};font-size:.75rem;padding:22px 0 8px;font-weight:500;'>"
            "\U0001f1ee\U0001f1f3 Restaurant Interactive Dashboard \u00b7 Built with Streamlit &amp; Plotly \u00b7 Final Year Project"
            "</div>", unsafe_allow_html=True)
